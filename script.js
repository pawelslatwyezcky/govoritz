...
function tellMe(phrase) {
    VoiceRSS.speech({
                key: 'bc49696a341142989bbd294097596f89',
                src: phrase,
                hl: 'ru-ru',
                v: 'Peter',
                r: 0, 
...
// Get Phrase from Array

let phrasesArray = [
'Кто лучше всех?...Это же вы!',
'Где самая сладкая пуся?...Да вон же, она в зеркале у вас',
'Я вас бууууль!',
'Вуф!',
'Рраф!',
'Вы самый сладкий пирожок!',
'У вас все получится!',
'Ну вы и пуся, канешна',
'Ну что за сладкость',
'Скучипууу',
'Покушой',
'Лава-мява',
'Пуся, вы самая сладкая',
'Выше нос, моя булочка',
'Вы моя маленкость',
'Выложите фоточки с Памуккале',
'Не получится у вас, не получится ни у кого'
]

let phrase = '';

function getPhrase() {
    phrase = phrasesArray[Math.floor(Math.random() * phrasesArray.length)]
    tellMe(phrase);
    toggleButton();
}
...
button.addEventListener('click',getPhrase);
